    ...
    return (
      <div style={{ backgroundColor: '#eee' }}>
        <Grid container style={{ paddingTop: 120 }}>
          ...
          <Grid item xs={12} sm={3} md={3} lg={4} xl={4} style={{ display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', width: '100%', paddingTop: 70 }}>
            <div style ={{ fontFamily: 'Helvetica Neue', color: 'black', fontSize: 14, paddingLeft: 20, width: '60%' }}>
            ...
            <p style={{ margin: 0, marginTop: 14, paddingLeft: 20, fontFamily: 'Helvetica Neue' }}>
              So, stop practicing in the mirror,
            </p>
            <div style={{ fontWeight: 700, color: 'black', fontSize: 18, width: '60%', paddingLeft: 20 }}>
              <span style={{ fontFamily: 'Helvetica Neue', color: 'black', fontSize: 14, width: '60%', fontWeight: 'normal', paddingRight: 1 }}>and  </span>
        ...
        <Grid container style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative', alignItems: 'center', width: '100%', zIndex: 50 }}>
          <StickyDiv>
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', flexDirection: 'row', position: 'relative' }}>
              <div id='cubeCont' className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'row' }}>
                <div className="scene">
                  <div
                    className="cube"
                    style={{
        ...
        <Grid container>
          ...
          <Grid container>
            ...
            <Grid container style={{ paddingTop: 400 }}>
              ...
              <Grid id='elevatorDoor' item xs={12} sm={12} md={12} lg={12} xl={12} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', width: '100%', position: 'relative', zIndex: 100 }} onClick={() => {
                console.log(this.state.showElevatorDoor);
              }}>
                <div style={{ width: '50%', position: 'absolute', top: 0 }}>
                  <StickyDiv offsetTop={this.state.stickyOffset} style={{ zIndex: 0, width: '50%', marginTop: -300 }}>
                    <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', zIndex: 110 }}>
                      <div
                        style={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', width: "14.3%", overflow: 'hidden', zIndex: 110 }}>
                        <ContainerDimensions>
                          {
                            ({ width }) => {
                              return (
                                <Motion style={{ x: spring(this.state.showElevatorDoor ? 0 : 0) }}>
                                  {({ x }) => {
                                    return (
                                      <img
                                        src='images/graphics/elevator-door-left3-cropped.png'
          ...
          <Grid container>
              ...
              <Grid container style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <img
                  src='images/graphics/stack-it2-bg.png'
