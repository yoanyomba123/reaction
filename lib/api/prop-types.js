...
const TagSchema = Tag.newContext();
 ...
 * @return {Error|undefined} returns an error if validation us unsuccessful
 */
 ...
 * @param  {Object} props An object containing all props passed into the component
 * @param  {String} propName Name of prop to validate
 * @return {Error|null} returns an error if validation us unsuccessful
 */
